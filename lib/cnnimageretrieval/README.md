...
<details>
  ...
  **Note**: Adjusted (lower) learning rate is set to achieve similar performance as with [MatConvNet](https://github.com/filipradenovic/cnnimageretrieval) and [PyTorch-0.3.0](https://github.com/filipradenovic/cnnimageretrieval/tree/v1.0) implementation of the training.
...
<details>
  ...
  - Whitening FC layer is precomputed for popular architectures and pooling methods, see [imageretrievalnet.py#L50](https://github.com/filipradenovic/cnnimageretrieval/blob/474b1fe61ff0e8a6f076ef58f7334cf33d7a3773/cirtorch/networks/imageretrievalnet.py#L50) for the full list of precomputed FC layers.
...
<details>
  ...
  #### [master](https://github.com/filipradenovic/cnnimageretrieval/tree/master) (development)
  
  - Added example script for descriptor extraction with different publicly available models
  - Added the [MIT license](https://github.com/filipradenovic/cnnimageretrieval/blob/master/LICENSE)
  ...
  - Added script to enable download on Windows 10 as explained in Issue [#39](https://github.com/filipradenovic/cnnimageretrieval/issues/39), courtesy of [SongZRui](https://github.com/SongZRui)
...
<details>
  ...
  #### [v1.1](https://github.com/filipradenovic/cnnimageretrieval/tree/v1.1) (12 Jun 2019)
...
<details>
  ...
  #### [v1.0](https://github.com/filipradenovic/cnnimageretrieval/tree/v1.0) (09 Jul 2018)
